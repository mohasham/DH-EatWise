...
export const snackTemplates: Omit<Meal, "id" | "time" | "eaten">[] = [
  {
    ...
    description: "A high-protein snack that curbs hunger between meals and supports muscle recovery.",
    recipe: [
  ...
  },
  {
    ...
    description: "A satisfying mix of fiber and healthy fats that keeps energy steady without a sugar spike.",
    recipe: [
  ...
  },
  {
    ...
    description: "A quick, drinkable snack packed with protein and greens \u2014 great around a workout.",
    recipe: [
  ...
  },
  {
    ...
    description: "A crunchy, low-calorie snack that adds an extra serving of vegetables to your day.",
    recipe: [
